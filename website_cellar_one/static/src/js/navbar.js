...
// Slugs must match the live cecelinewines.com catalog
// (see data/website_data.xml — menu_wines/menu_spirits/menu_beer/menu_cider).
// Keep these in sync if the category IDs change.
const FALLBACK_NAV_ITEMS = [
    ["Wines", "/shop/category/wines-27"],
    ["Spirits", "/shop/category/spirits-28"],
    ["Beer", "/shop/category/beer-34"],
    ["Cider", "/shop/category/cider-35"],
    ["Brands", "/shop"],
    ["Find Us", "/location"],
];
